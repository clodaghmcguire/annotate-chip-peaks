...
## annotate peaks
peakAnno_GSM970258_A <- annotatePeak('GSM970258_GATA1-A_peaks.bed.gz', tssRegion=c(-3000, 3000), TxDb=txdb, annoDb="org.Hs.eg.db")
peakAnno_GSM970257_F <- annotatePeak('GSM970257_GATA1-F_peaks.bed.gz', tssRegion=c(-3000, 3000), TxDb=txdb, annoDb="org.Hs.eg.db")
...
tagHeatmap(tagMatrix_GSM970258_A, xlim=c(-3000, 3000), color="red")
