...
## visualise peaks for GATA1 adult and fetal samples using trackviewer###
Adult <- importScore('./GSE36994_hg19/GSM970258_GATA1-A_hg19.bw', format='BigWig')
Fetal <- importScore('./GSE36994_hg19/GSM970257_GATA1-F_hg19.bw', format='BigWig')
